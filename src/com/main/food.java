...
public class food {
	...
	public food(int id, String foodName, String foodCat, double foodPrice, int vendor_idVendor, int foodquantity) {
		super();
		this.id = id;
	...
	public String toString() {
		return "food [id=" + id + ", foodName=" + foodName + ", foodCat=" + foodCat + ", foodPrice=" + foodPrice
				+ ", Vendor_idVendor=" + Vendor_idVendor + ", foodQuantity=" + foodQuantity + "]";
	}
